...
* 视觉设计师/AI设计师/品牌设计师的个人作品集展示网站
* 面向潜在客户、雇主和同行，展示个人专业能力、作品案例和联系方式
* 目标：打造高级、克制、有科技感的暗色系视觉作品集，区别于模板化网站
...
* 主色：深黑色 (#0a0a0a) 到深灰色 (#141414)
* 强调色：科技蓝 (#00d4ff) 或 霓虹紫 (#a855f7)
* 文字色：白色 (#ffffff) 和浅灰色 (#a1a1aa)
* 辅助色：暗金色 (#fbbf24) 用于hover高亮

### 3.2 字体选择

* 标题：思源黑体 (Noto Sans SC) Bold 或 Orbitron（科技感）
* 正文：Inter 或 Roboto
* 中文使用思源黑体
...
* Desktop-first（PC端优先）
* 适配1920px、1700px、1440px等主流分辨率
* 移动端暂不考虑
* 对标网站：Build a 3D Creator portfolio landing page for "Jack" using React, TypeScript, Tailwind CSS, Framer Motion, and Lucide React. The page has a dark theme (#0C0C0C background) with the font Kanit (Google Fonts, weights 300-900). The page title is "Jack -- 3D Creator".
